...
As for the task of misclassification detection, the S-BGCN-T-K model trained using the pixel prior is the highest ranked model.
...
The performance of the S-BGCN-T-K model trained using the pixel prior stands out above the performance of other models trained.
