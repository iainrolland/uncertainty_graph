...
To do so, we have used graph-based neural network architectures that are adapted to provide subjective opinions \cite{Kipf2017, ZhaoXujiang2020}, as described in the field of belief or evidence theory \cite{Josang2018}.
...
Aleatoric uncertainty, which accounts for noise inherent to the data observations and cannot be reduced with extra samples \cite{Kendall2017}, is given by
\begin{equation}
